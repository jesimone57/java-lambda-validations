...
public class OldFashionedPersonValidator implements IPersonValidator {
	...
	public void validate(Person person) {
		...
		if (!(fn.equals("bill") || fn.endsWith("william"))) throw new IllegalArgumentException("firstname : must be bill or william");
	}
